            ...
            <div className='flex flex-col gap-2 mt-6'>
                ...
                <div className='flex gap-3'>
                    <button 
                        ...
                        className={`px-6 py-2 rounded-full border transition-all ${paymentMethod === 'CASH' ? 'bg-primary text-white border-primary' : 'text-gray-500 border-gray-300'}`}
                    >
                        Cash (Pay at Clinic)
                    </button>
                    <button 
                        onClick={() => setPaymentMethod('ONLINE')} 
                        className={`px-6 py-2 rounded-full border transition-all ${paymentMethod === 'ONLINE' ? 'bg-primary text-white border-primary' : 'text-gray-500 border-gray-300'}`}
                    >
                        Pay Online
                    </button>
                </div>
